...
{
    public sealed class DefaultMimeTypeMapper : IMimeTypeMapper
    {
        ...
        public DefaultMimeTypeMapper()
        {
            ...
            AllowFallbackMimeType = false;
            AllowUnknownMimeType = false;
        ...
        public bool AddOrUpdateMimeType(string extension, string mimeType)
        {
            ...
            lock (_lock)
            {
                ...
                _mimeTypeMap[extension] = mimeType;
        ...
        public IReadOnlyDictionary<string, string> MimeTypeMappings
        {
            get
            {
                lock (_lock)
                {
                    return new ReadOnlyDictionary<string, string>(_mimeTypeMap);
                }
            }
        }
    }
